...
var XpiInstaller = {
	...
	extFullName: 'ghostfox', // The name displayed to the user (don't include the version)
	extShortName: 'ghostfox', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1.4',
	extAuthor: 'Balaganesh Damodaran - concex induxtre',
